...
const mockUser = {
  ...
  recentActivity: [
    { id: 1, action: "Verified mangrove plantation", location: "Sundarbans", date: "2 hours ago", points: "+15" },
    {
      id: 2,
      action: "Completed beach cleanup verification",
      location: "Marina Beach",
      date: "1 day ago",
      points: "+20",
    },
    { id: 3, action: "Verified coral restoration", location: "Andaman Islands", date: "3 days ago", points: "+25" },
    { id: 4, action: "Submitted water quality report", location: "Ganga River", date: "1 week ago", points: "+10" },
  ],
}
  ...
  return (
    <div className="min-h-screen relative overflow-hidden pb-20">
      <div className="absolute inset-0 z-0">
        <Image src="/ocean-conservation-hero.jpg" alt="Ocean conservation" fill className="object-cover" />
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">Your conservation journey</p>
              </div>
            </div>
          ...
          <CardContent className="pt-8 pb-8">
            <div className="flex flex-col items-center text-center space-y-6">
              <div className="relative">
                <Avatar className="h-32 w-32 border-4 border-gradient-to-br from-blue-400 to-green-500">
                  <AvatarImage src={user.avatar || "/placeholder.svg"} alt={user.name} />
                  <AvatarFallback className="text-3xl font-bold bg-gradient-to-br from-blue-500 to-green-600 text-white">
                    {getInitials(user.name)}
                  </AvatarFallback>
                </Avatar>
                <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center border-4 border-white">
          ...
          <Card className="bg-white/95 backdrop-blur-xl border-white/30 shadow-xl">
            <CardContent className="pt-6 pb-6">
              <div className="text-center">
                ...
                <div className="text-3xl font-bold text-blue-600">{user.totalVerifications}</div>
          ...
          <CardContent>
            <div className="space-y-4">
              {user.recentActivity.map((activity) => (
                ...
                >
                  <div className="w-3 h-3 bg-gradient-to-r from-blue-500 to-green-500 rounded-full mt-2 flex-shrink-0" />
